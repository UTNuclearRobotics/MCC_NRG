...
from mcc_nrg.utils.pos_embed import get_2d_sincos_pos_embed
from mcc_nrg.config import MCCConfig, load_model_config
...
class MCCDecoderBlock(nn.Module):
    def __init__(
        ...
        self.attn = MCCDecoderAttention(dim, num_heads=num_heads, qkv_bias=qkv_bias, attn_drop=attn_drop, proj_drop=drop)
...
class MCC(nn.Module):
    ...
    def __init__(self, *,
        ...
        self.regress_color = regress_color
...
def load_model(model_config_path: str,
    ...
    # Load YAML
    cfg: MCCConfig = load_model_config(model_config_path)
    params = cfg.model
